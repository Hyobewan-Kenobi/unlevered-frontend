        ...
        <footer className="pt-10">
            <div className="max-w-screen-xl mx-auto px-4 text-white md:px-8">
                <div className="space-y-6 sm:max-w-md sm:mx-auto sm:text-center">
                    <img src="/Unlevered-Logo-253x55.png" className="w-32 sm:mx-auto" />
                    <p>
                    Equity Research for the Everyday Investor.
                    </p>
                ...
                <div className="mt-10 py-10 border-t items-center justify-between sm:flex">
                    <p>© 2024 Unlevered.ai | All rights reserved.</p>
                    <ul className="flex flex-wrap items-center gap-4 mt-6 sm:text-sm sm:mt-0">
                        {
                            footerNavs.map((item, idx) => (
                                <li className="text-white hover:text-gray-500 duration-150">
